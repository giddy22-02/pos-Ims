    ...
    <div class="modal fade" id="detail<?php echo $sqrow['salesid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
				...
				<?php
					$sales=mysqli_query($conn,"select * from sales left join sales_person on sales_person.userid=sales.userid where salesid='".$sqrow['salesid']."'");
					$srow=mysqli_fetch_array($sales);
				?>
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							<span>Sales Person Name: <strong><?php echo ucwords($srow['person_name']); ?></strong></span>
